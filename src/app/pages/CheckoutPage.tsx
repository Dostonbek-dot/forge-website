    ...
    <section className="w-full bg-white">
      <Container>
        <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={transition()} className="py-[32px] lg:py-[48px]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-[24px] grid grid-cols-1 gap-[32px] lg:grid-cols-[1fr_380px] lg:gap-[40px]">
            <div className="flex flex-col gap-[28px]">
              ...
              <fieldset className="flex flex-col gap-[14px]">
                ...
                />
                <Field label="Address line 2 (optional)" placeholder="Apt, suite, etc." {...register("addressLine2")} />
                <div className="grid grid-cols-1 gap-[14px] sm:grid-cols-3">
                  ...
                  <Field
                    ...
                    {...register("postalCode", {
                      required: "Required",
                      pattern: { value: /^\d{6}$/, message: "Invalid postal code" },
                    })}
                  />
                </div>
